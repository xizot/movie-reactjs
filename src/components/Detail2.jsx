...
import $ from 'jquery';
function Detail2({
    poster = `${process.env.PUBLIC_URL}/assets/img/films/movies07.png`,
    ...
    return (
        <div className='p-detail2 u-fade '>
            <div
                className={
                    isPlay
                        ? 'p-detail2__content is-play'
                        : 'p-detail2__content is-pause'
                }
            >
                ...
                <p
                    to='/'
                    className='c-btn--play c-icon--play'
                    onClick={() => handlePlay()}
                >
                    <CaretRightOutlined />
                </p>
                <p
                    to='/'
                    className='c-btn--play c-icon--pause'
                    onClick={() => handlePlay()}
                >
                    <PauseOutlined />
                </p>
